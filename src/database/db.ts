...
export const getDb = () => {
  if (!dbPromise) {
    dbPromise = openDB<CaixaDB>("caixa-facil-mrs-db", 4, {
        ...
        if (oldVersion < 2) {
          ...
          while (cursor) {
            ...
            const migratedProduct: Produto = {
              ...
              ...(isCarne ? { nome: "Produto Exemplo 1", preco: 10, ordem: 1, categoriaId: "cat-produtos" } : {}),
              ...(isLinguica ? { nome: "Produto Exemplo 2", preco: 15, ordem: 2, categoriaId: "cat-produtos" } : {}),
            };
